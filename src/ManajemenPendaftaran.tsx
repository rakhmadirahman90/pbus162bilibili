  ...
  try {
    const { error } = await supabase
      ...
      .update({
        ...
        // Pastikan nilai ini SAMA PERSIS dengan yang ada di Supabase Constraint
    ...
    // Menampilkan pesan error spesifik dari database agar mudah didebug
    Swal.fire('Gagal Update', `Error: ${err.message}`, 'error');
  } finally {
    setIsSaving(false);
  }
};
