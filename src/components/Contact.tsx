      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          ...
          <div className="space-y-8">
            <div className="bg-slate-800/50 p-8 rounded-3xl border border-white/10 backdrop-blur-sm shadow-xl">
              ...
              <div className="space-y-6">
                <div className="flex gap-4">
                  ...
                  <div>
                    <h4 className="font-bold text-slate-300 text-sm uppercase tracking-wider mb-1">Alamat Utama</h4>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <h4 className="font-bold text-slate-300 text-sm uppercase tracking-wider mb-1">Jam Operasional</h4>
                    <p className="text-slate-100">Senin - Sabtu: 08.00 - 22.00 WIB</p>
                    <p className="text-slate-400 text-sm">Minggu: Hanya Untuk Pertandingan Internal</p>
                  </div>
                </div>
            ...
            <button className="w-full py-4 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-500 hover:to-blue-600 rounded-2xl font-bold uppercase tracking-[0.2em] shadow-lg shadow-blue-900/20 transition-all flex items-center justify-center gap-2 group">
              Buka di Google Maps
          ...
          <div className="w-full h-[450px] lg:h-full min-h-[450px] rounded-3xl overflow-hidden border-4 border-slate-800 shadow-2xl relative group">
            <iframe 
              src="https://maps.app.goo.gl/2iqvqSC7QaFLrnZy9" 
              width="100%" 
              height="100%" 
            ...
            ></iframe>
            {/* Overlay Gradient agar Map menyatu dengan UI Dark Mode */}
            <div className="absolute inset-0 pointer-events-none shadow-[inset_0_0_100px_rgba(15,23,42,0.5)]"></div>
          </div>
