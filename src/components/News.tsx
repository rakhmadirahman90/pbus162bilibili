            ...
            <div className="overflow-y-auto custom-scrollbar-smooth flex-grow">
              ...
              <div className="p-8 md:p-14 bg-white relative">
                ...
                <div className="mt-20 pt-10 border-t border-gray-100">
                  <button 
                    onClick={() => setSelectedNews(null)} 
                    className="w-full bg-gray-900 hover:bg-blue-600 text-white py-5 rounded-2xl font-black uppercase text-sm tracking-[0.4em] transition-all transform active:scale-95"
                  >
