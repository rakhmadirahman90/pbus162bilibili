...
  { id: 7, name: 'Mustakim', category: 'Seeded A', ageGroup: 'Atlet Senior', rank: 7, achievements: 4, image: 'whatsapp_image_2026-02-05_at_10.36.22.jpeg' },
...
  { id: 21, name: 'Vhio', category: 'Seeded B(+)', ageGroup: 'Atlet Senior', rank: 21, achievements: 2, image: 'whatsapp_image_2026-02-05_at_10.34.12.jpeg' },
...
      // Urutkan berdasarkan Rank (A dulu, lalu B+, dst)
...
              "Salah satu pejuang lapangan terbaik dari kategori {selectedPlayer.category} yang memperkuat solidaritas tim PB US 162."
            </p>
          </div>
        </div>
      </div>
...
          <button onClick={() => setShowAll(!showAll)} className="group flex items-center gap-4 bg-white text-black px-10 py-4 rounded-full font-black text-xs uppercase tracking-[0.3em] transition-all hover:bg-blue-600 hover:text-white shadow-2xl">
